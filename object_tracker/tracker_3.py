...
import sys
sys.path.append("C:\\Users\\Balam\\OneDrive\\Desktop\\Infosys_springboard\\Smart_Traffic_Management_System\\object_tracker")
from utils.util import get_car, read_license_plate, write_csv
...
class Tracker:
    ...
    def __init__(self):
        # load models
        self.vehicle_detection_model = YOLO("yolov8x.pt")
        self.license_plate_detector = YOLO("C:\\Users\\Balam\\OneDrive\\Documents\\ANPR_and_ATCC_for_Smart_Traffic_Management\\trained model for testing purpose\\new_best_2nd_dec.pt")
        self.results = {}
        self.vehicles = [2, 3, 5, 7]
    ...
    def process_video(self, frames):
        ...
        for frame_no, frame in enumerate(frames):
            ...
            #     break
        # write results
        write_csv(self.results, "C:\\Users\\Balam\\OneDrive\\Desktop\\Infosys_springboard\\Smart_Traffic_Management_System\\output\\main.csv")